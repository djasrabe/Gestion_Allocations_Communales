...
namespace GesBudget
{
    public partial class ListePayement : Form
    { 
        ...
        private void ListePayement_Load(object sender, EventArgs e)
        {
        ...
        {
            AccesBD obj = new AccesBD();
            DataTable datatable = obj.Visualiser("select NumPayement,NumArticle,Date_Payement,Annee As Exercice_Budgetaire,Libelle_Payement,Montant from Payement WHERE Annee='" + comboBox1.SelectedValue + "' ORDER BY Date_Payement");
            dataGridView1.DataSource = datatable;
        }
