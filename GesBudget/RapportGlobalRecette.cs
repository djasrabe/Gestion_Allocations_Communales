...
namespace GesBudget
{
    public partial class RapportGlobalRecette : Form
    {
        ...
        public void Rapport(string exercice)
        {
            ...
            object budget = obj2.Select("select sum(Budget.Montant) from Budget,Article,Chapitre Where Annee='" + comboBox1.Text + "'"+ "and Budget.NumArticle=Article.NumArticle and Article.NumChapitre=Chapitre.NumChapitre and Chapitre.Type='Recette'");
            object payement = obj2.Select("select sum(Montant) from Recette where Annee='" + comboBox1.Text + "'");
            ...
            dt.Rows.Add("Total Recettes:", label8.Text);
            dt.Rows.Add("% Execution:", label10.Text);
            dataGridView2.DataSource = dt;

        }
        private void RapportGlobalRecette_Load(object sender, EventArgs e)
        {

           // dataGridView2.Columns.Add("taux", "% Execution");
        ...
        {           
            if (bFirstPage == true)
            {
                ...
                string texte1 = "EXECUTION BUDGETAIRE - VOLET RECETTES, " + " Execice " + " " + comboBox1.Text;
