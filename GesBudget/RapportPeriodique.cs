...
namespace GesBudget
{
    public partial class RapportPeriodique : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string requete = "select * from Recette where Date_Recette Between DateValue('" + dateTimePicker1.Value.Date + "') and DateValue('" + dateTimePicker2.Value.Date + "') Order By Date_Recette ASC";   
            DataTable datatable = obj1.Visualiser(requete);
            dataGridView1.DataSource = datatable;

            //----total recette entre deux dates date dans le label
            
            string req2 = "select sum(Montant) from Recette where Date_Recette Between DateValue('" + dateTimePicker1.Value.Date + "') and DateValue('" + dateTimePicker2.Value.Date + "')";
            label11.Text = obj1.Select(req2).ToString();

            if (label11.Text == "") label11.Text = "00";

                              
            //gerer les payements
            AccesBD obj2 = new AccesBD();
            string req = "select * from Payement where Date_Payement Between DateValue('" + dateTimePicker1.Value.Date+"') and DateValue('" + dateTimePicker2.Value.Date + "') Order By Date_Payement ASC";   

            DataTable datatable2 = obj2.Visualiser(req);
            dataGridView2.DataSource = datatable2;


            //----total payements entre deux dates date dans le label

            string req3 = "select sum(Montant) from Payement where Date_Payement Between DateValue('" + dateTimePicker1.Value.Date + "') and DateValue('" + dateTimePicker2.Value.Date + "')";
            label13.Text = obj2.Select(req3).ToString();
            if (label13.Text == "") label13.Text = "00";
            ...
            label5.Text = "Au";
            label7.Text = (dateTimePicker2.Value.Date).ToString("dd/MM/yyyy");
        ...
        private void RapportPeriodique_Load(object sender, EventArgs e)
        {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            if (bFirstPage == true)
            {
                ...
                string texte1 = "Recettes effectuées dans la Periode du " + label3.Text + " " + "au" + " " + label7.Text;
        ...
        private void printDocument2_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
          //---
            if (bFirstPage == true)
            {
                ...
                string texte1 = "Depenses effectuées dans la Periode du " + label3.Text + " " + "au" + " " + label7.Text;
                Font fonttext1 = new Font("Verdana", 10, FontStyle.Bold);
                e.Graphics.DrawString(texte1, fonttext1, Brushes.Blue, new Point(80, 120));
